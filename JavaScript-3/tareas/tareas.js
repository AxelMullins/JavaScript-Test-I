...
function todosIguales(arreglo) {
  ...
  return (resultado / arreglo.length == arreglo[0]) ? true : false
} 
...
function mesesDelAño(array) {
  ...
  // Tu código:
  let findEnero = array.includes("Enero")
  let findMarzo = array.includes("Marzo")
  let findNoviembre = array.includes("Noviembre")

  const nuevoArray = ["Marzo","Noviembre","Enero"]

  return (findEnero && findMarzo && findNoviembre) 
    ? nuevoArray 
